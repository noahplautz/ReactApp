...
export function Picker(props) {
  ...
  return (
    ...
    <div id="picker" className="golf" style={{
      ...
      <input type="text" id="score-input" placeholder="Score" value={score} onChange={e => parseInt(setScore(e.target.value))}></input>

      <button onClick={() => props.add({course, date, weather, holes, score})}>Add Round</button>
